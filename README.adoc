...
GROUP BY
    `type`;
```
image::https://user-images.githubusercontent.com/63274055/147837990-b49288f8-da2e-45b0-8e1f-82333b685b36.png[width=600]
...
image::https://user-images.githubusercontent.com/63274055/147839479-0fa51f8d-768f-4d4d-adad-f2ae785f2050.png[width=600]
